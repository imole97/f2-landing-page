    ...
    <div className="bg-white">
      <Container>
        <div className="flex pt-16 justify-center">
          <div
            id="client-portfolio"
            className="bg-[#FFBB00]  justify-center py-2 px-4 rounded-full text-[#040404] font-medium"
          >
            Clients’ Portfolio
          </div>
        </div>
        ...
        <div className="flex w-full pb-10 gap-16 justify-center min-w-0 overflow-x-auto items-center">
          {clientImages.map((image) => (
            <CustomImage
              key={image.img}
              className={`${image.aspect} flex-1 !object-contain w-full`}
              alt="client-image"
              src={image.img}
            />
          ))}
        ...
        <div className="flex gap-6 w-full">
          <CustomImage
            ...
            className="aspect-[542/520] w-[40%]"
            src="/images/f2-guys.jpg"
          />
          <CustomImage
            alt="f2-squad"
            imgClassname="rounded-[12px]"
            className="aspect-[734/519] w-[60%]"
            src="/images/f2-squad.jpg"
          />
        </div>
      </Container>
    </div>
