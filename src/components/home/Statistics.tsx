        ...
        <div className="py-10 flex flex-col xl:gap-12 xl:flex-row items-center">
          <div className="xl:max-w-[626px]">
            ...
            <p className="text-3xl text-[#040404] leading-relaxed mb-8">
              We are the architects of <span className="font-bold">&quot;tomorrow&#39;s ventures&quot;</span> dedicated to democratizing entrepreneurship, institutionalizing venture building and driving corporate innovation on the continent.
            </p>
          </div>
            ...
            <div className="relative w-full">
              ...
              <div className="absolute bottom-4 w-[61px] left-4">
                <CustomImage alt="f2-image" className="aspect-[61/61] lg:aspect-[98/96]" src="/images/f2.png"/>
              </div>
            </div>
          </div>
      </Container>
