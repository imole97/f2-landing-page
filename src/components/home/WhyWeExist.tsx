...
const WhyWeExist = () => {
  return (
    <div className="bg-[rgb(13,16,47)]  py-10">
      <Container>
        <h4 className="font-medium text-5xl lg:text-7xl text-center mb-10">Why We Exist</h4>
        ...
        <CustomImage alt="multi-images" className="aspect-[1300/356] w-full my-18" src="/images/multi-images.png"/>
      </Container>
    </div>
  );
};
