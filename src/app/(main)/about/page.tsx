      ...
      <section className="py-20 px-[5%] bg-white">
        ...
        <div className="bg-gray-900 z-50 text-white mt-20 p-8 rounded-xl">
          ...
          <p className="text-base md:text-3xl leading-relaxed">
            ...
            nurtured with the right expertise and resources, can transform into
            a flourishing enterprise. We are the launchpad for audacious
            founders, providing the comprehensive support needed to navigate the
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-[#EBFAFA] h-fit p-8 rounded-2xl">
            ...
            <div className="space-y-4 text-base text-[#040404] md:text-3xl leading-relaxed">
              <p>
                From &#39;Idea&#39; to &#39;Scaled, Acquirable Product&#39;, F2
                consistently delivers a comprehensive, hands-on venture-building
                experience that transforms early-stage ideas into de-risked,
                high-growth, and investment-ready companies with strong
          ...
          <div>
            ...
            <div className="space-y-6 text-[#040404] text-base md:text-3xl leading-relaxed">
              <p>
                ...
                averaging <strong>6.5x MOIC</strong>, FirstFounders is more than
                just building companies; we&#39;re building a movement. We are
                committed to driving innovation and economic growth across
                Africa, empowering entrepreneurs to build successful and
                sustainable businesses that improve lives and contribute to a
                better planet.
              </p>
              ...
              <p>
                ...
                simultaneously fostering a collaborative ecosystem that promotes
                knowledge sharing and growth.
              </p>

              <p>
                <strong>FirstFounders (F2)</strong> is committed to transforming
                the entrepreneurial landscape, enabling the bold ideas of today
                to become the defining ventures of tomorrow.
              </p>
            </div>
          </div>
        </div>
